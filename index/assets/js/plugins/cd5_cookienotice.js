...
(function () {
    ...
    window.cookieNoticeJS = function () {
        ...
        dismissButton.addEventListener('click', function (e) {
            ...
            window.dispatchEvent(
              new CustomEvent("engage:cookie:preferences:changed", {
                detail: { functional: 1, analytical: 1 },
              })
            );
    ...
    function createDismissButton(message, buttonColor, buttonTextColor) {
        ...
        dismissButton.setAttribute("id", "cookie_confirm_btn");dismissButton.setAttribute("id", "cookie_confirm_btn");
